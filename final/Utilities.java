...
public class Utilities {
    ...
    public static Displaux displaux(Node a) {
        if (a.right == null && a.left == null) { // a is a leaf
            // String line = a.num + "";
            // if (a.color.equals("red")) line = "[" + line + "]";
            String line = a + ""; // Jack's improvement
        ...
        if (a.right == null) {
            ...
            int p = result.height;
            int x = result.middle;
            // String s = a.num + ""; // our node value
            // if (a.color.equals("red")) s = "[" + s + "]";
            String s = a + ""; // Jack's improvement
            int u = s.length();
